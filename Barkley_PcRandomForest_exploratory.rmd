...
```{r message=FALSE}
library(dplyr)
pcplot <- read.csv('C:\\Users\\yvonne.barkley\\Documents\\PHD\\BigRoccaFile_PMN_TowedAll_EDIT_20180816.csv')

pcplot <- read.csv('C:\\Users\\yvers\\Documents\\CHP 1\\data\\ROCCA Towed Data\\BigRoccaFile_PMN_TowedAll_EDIT_20181124.csv')



pcplot$population = as.character(pcplot$population)
pcplot$population[pcplot$population == 'mhi'] = "MHI"
pcplot$population[pcplot$population == 'pel'] = "Pelagic"
pcplot$population[pcplot$population == 'nwhi'] = "NWHI"
pcplot$population = as.factor(pcplot$population)

pcplot$EncounterID = as.character(pcplot$EncounterID)
pcplot$EncounterID[pcplot$EncounterID == 'PcMHI31'] = "M2"
pcplot$EncounterID[pcplot$EncounterID == 'PcMHI32'] = "M3"
pcplot$EncounterID[pcplot$EncounterID == 'PcMHI33'] = "M4"
pcplot$EncounterID[pcplot$EncounterID == 'PcMHI34'] = "M1"
pcplot$EncounterID[pcplot$EncounterID == 'PcPEL1'] = "P6"
pcplot$EncounterID[pcplot$EncounterID == 'PcPEL2'] = "P1"
pcplot$EncounterID[pcplot$EncounterID == 'PcPEL3'] = "P2"
pcplot$EncounterID[pcplot$EncounterID == 'PcPEL4'] = "P4"
pcplot$EncounterID[pcplot$EncounterID == 'PcPEL5'] = "P5"
pcplot$EncounterID[pcplot$EncounterID == 'PcPEL6'] = "P3"
pcplot$EncounterID[pcplot$EncounterID == 'PcPEL7'] = "P8"
pcplot$EncounterID[pcplot$EncounterID == 'PcPEL8'] = "P7"
pcplot$EncounterID[pcplot$EncounterID == 'PcNWHI14'] = "N2"
pcplot$EncounterID[pcplot$EncounterID == 'PcNWHI15'] = "N3"
pcplot$EncounterID[pcplot$EncounterID == 'PcNWHI16'] = "N4"
pcplot$EncounterID[pcplot$EncounterID == 'PcNWHI17'] = "N1"
pcplot$EncounterID = as.factor(pcplot$EncounterID)

pcplot <- pcplot[, -c(54:61)]

write.csv(pcplot, 'C:\\Users\\yvonne.barkley\\Documents\\PHD\\BigRoccaFile_PMN_TowedAll_EDIT_20180914.csv' )

#PIFSC desktop
pcplot<- read.csv('C:\\Users\\yvonne.barkley\\Documents\\PHD\\BigRoccaFile_PMN_TowedAll_EDIT_20180914.csv')
...
##Multipanel Density plots of variables within and between populations
```{r}
### 9/12/2018 ####
library(ggplot2)
library(reshape2)
...
for(nm in names){
plots.P[[nm]]<- ggplot(pcdata.P, aes_string(x=nm, fill=pcdata.P$EncounterID)) +  geom_density(alpha = 0.5) +
    theme_bw()+
    theme(plot.background = element_rect(fill = "white"),
        axis.title.x=element_text(size=10, face='bold'),
        axis.text.x=element_text(size=8),
...
#arrange plots 
multipage <- ggarrange(plotlist=plots.P, ncol = 2, nrow = 4, common.legend = TRUE, legend = "top" )
#export plots to multiple pages
...
freqslope=ggplot(pcplot, aes(x = EncounterID, y = FREQSPREAD, col=as.factor(population))) +
  geom_boxplot() +
  theme_bw() +

...
#using party
ptm<-proc.time()
 cfit2 <- cforest(cformPc, data=train.pm,  controls=cforest_control(mincriterion = 0,ntree=500, mtry = 7, minsplit = 10L, minbucket = 5L))
 proc.time() - ptm
...
mtry_vals = 7 
ntree_vals = seq(101,201,50) #from, to, by
ctune_settings = expand.grid(mtry = mtry_vals, ntree = ntree_vals)

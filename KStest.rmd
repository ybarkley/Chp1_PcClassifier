...
levels(ks$comparison) <- c('Pelagic-NWHI', 'Pelagic-MHI', 'NWHI-MHI')
...
##For plotting all variables to show signif and non-signif
...
ks$variable[grep("INFLMAXMINDELTA", ks$variable)] <- "MaxInflTime/MinInflTime"
...
ks$variable[grep("NUMSWEEPSFLATUP", ks$variable)] <- "NumTimesZeroToPos"
ks$variable[grep("FREQENDDWN", ks$variable)] <- "BegDwnFreq"
...
#write.csv(ks, 'C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results/2018/20181125_KS Tests/KStests_ALL.csv', row.names = F)
```
...
ggsave('C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\plots/KS TEST_20181212-new.png', width = 12, height = 8, units = "in", type = "cairo-png")  

...
formPc_enc <- as.formula(paste("EncounterID ~ ", paste(names(pcdata)[7:32],collapse="+"))) #Use variables to classify to encounter
...
write.table(results.enc, 'C:\\Users\\Yvonne\\Documents\\PHD\\CHP1-FKW\\data\\results\\20180720/Encounters_MHI_20180721.csv', sep=",", append=TRUE)

write.table(varIMPtotal.enc, 'C:\\Users\\Yvonne\\Documents\\PHD\\CHP1-FKW\\data\\results\\20180720/Encounters_MHI_ImpVar_20180721.csv', sep=",", append=TRUE)

...
#To make the confusion matrix spit out encounters in order
=======
>>>>>>> bbdd5a62c6fe872c9118be70e33c2fd130189b86
...
Kappa Calculations
```{r}
confmat <- read.csv('data/results/PcResults_Encounters_TotalResults_MHI_20190312.csv', header=T, row.names = 1)
<<<<<<< HEAD

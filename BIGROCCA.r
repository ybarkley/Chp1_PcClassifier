...
write.csv(big_ROCCA, 'C:\\Users\\Yvonne\\Documents\\PHD\\CHP1-FKW\\data\\2017- 100 New Whistles\\concatenate/BigRoccaFile_PMN_TowedAll_RAW_20180816.csv', row.names=F)
...
filenames <- list.files(path="C:\\Users\\Yvonne\\Documents\\PHD\\CHP1-FKW\\data\\2017- 100 New Whistles\\Raven Data\\concatenate", 
                        pattern=".*csv")
...
#Load csvs
for(i in names){
  filepath <- file.path("C:\\Users\\Yvonne\\Documents\\PHD\\CHP1-FKW\\data\\2017- 100 New Whistles\\Raven Data\\concatenate" ,paste(i,".csv",sep=""))
...
write.csv(bindIT, 'C:\\Users\\Yvonne\\Documents\\PHD\\CHP1-FKW\\data\\2017- 100 New Whistles\\concatenate\\PcNWHI15.csv', row.names=F)

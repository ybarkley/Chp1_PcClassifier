...
#Change variable names before tabulating
top_10all$Variable[grep("DURATION", top_10all$Variable)] <- "Duration"
top_10all$Variable[grep("FREQQUARTER3", top_10all$Variable)] <- "ThirdQuarterFreq"
...
top_10all$Variable[grep("INFLMEANDELTA", top_10all$Variable)] <- "MeanTimeBtwnInfl"
top_10all$Variable[grep("FREQABSSLOPEMEAN", top_10all$Variable)] <- "AbsSlopeMean"
...
varRange <- cbind(varmin, "Max" =varmax$Max)
write.csv(varRange, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\Variable Importance/PcResults_Top10ImpVars_Range.csv", row.names = F)
...
top_10tab <- read.csv("C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\20181209_PMN_100x/PcResults_Top10ImpVarsTABLE_ALL_20181209.csv")

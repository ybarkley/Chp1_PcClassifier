...
top_vars <- read.csv("C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2019\\March 2019\\PcResults_PMN_ImportantVars_20190322_EDIT.csv")
top_varsPN <- read.csv("C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2019\\PcResults_PN_ImportantVars_20190527.csv")
top_varsPM <- read.csv("C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2019\\PcResults_PM_ImportantVars_20190325_EDIT.csv")
...
top_10 <- top_10[,c(1,2,6)]
top_10PN <- top_10PN[, c(1,2,5)]
top_10PM <- top_10PM[, c(1,2,5)]
...
write.csv(varRange, 'PcResults_Top10ImpVars_Range_20190326.csv', row.names = F)
...
Heat map of most important variables (originally removed from manuscript)
```{r}
require(ggplot2)
...
heat <- ggplot(top_10tab_all, aes(model, Var1)) + 
        labs(x="", y="Whistle Variable", title = "Most Important Variables for Whistle Classification") +
  theme(plot.background = element_rect(fill = "white"),
...
ggsave('C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\plots/PcResults_Top10ImpVarsTABLE_ALL_20181213_HeatMap.png', width = 12, height = 8, units = "in", type = "cairo-png")  

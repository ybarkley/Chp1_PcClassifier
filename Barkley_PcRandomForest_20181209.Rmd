...
write.table(output_CorrectClass, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\20181209_PMN_100x/PcResults_ConfusionMatrix_PMN_20181209.csv", append = T, row.names = T, col.names=T, sep = ",")

write.table(output_Results, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\20181209_PMN_100x/PcResults_TotalResults_PMN_20181209.csv", append = T, row.names = T, col.names=T, sep = ",")

write.table(output_WhistleClass, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\20181209_PMN_100x/PcResults_TotalWhistleClass_PMN_20181209.csv", append = T, row.names = F, col.names=T, sep = ",")

write.table(output_TrainSetAll, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\20181209_PMN_100x/PcResults_TrainSets_PMN_20181209.csv", append = T, col.names=T, sep = ",")

write.table(output_TestSetAll, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\20181209_PMN_100x/PcResults_TestResults_PMN_20181209.csv", append = T, col.names=T, sep = ",")

write.table(output_varIMPtotal, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\20181209_PMN_100x/PcResults_ImportantVars_PMN_20181209.csv", append = T, col.names=T, sep = ",")

write.table(tunedAll, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\20181209_PMN_100x/PcResults_TunedParameters_PMN_20181209.csv", append = T, col.names=T, sep = ",")

write.table(output_ModelFit, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\20181209_PMN_100x/PcResults_TotalModels_PMN_20181209.csv", append = T, col.names=F, sep = ",")

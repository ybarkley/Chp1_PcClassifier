...
true.pel = if(results.pmtemp[1,1] >= t*w) 'Pelagic' else 'Ambiguous'
#pel.nwhi = if(results.pntemp[1,2] >= t*w) 'NWHI' else 'Ambiguous'
pel.mhi = if(results.pmtemp[1,2] >= t*w) 'MHI' else 'Ambiguous'

#true.nwhi = if(results.pmtemp[2,2] >= t*w) 'NWHI' else 'Ambiguous'
#nwhi.pel = if(results.pntemp[2,1] >= t*w) 'Pelagic' else 'Ambiguous'
#nwhi.mhi = if(results.pmtemp[2,3] >= t*w) 'MHI' else 'Ambiguous'

true.mhi = if(results.pmtemp[2,2] >= t*w) 'MHI' else 'Ambiguous'
mhi.pel = if(results.pmtemp[2,1] >= t*w) 'Pelagic' else 'Ambiguous'
#mhi.nwhi = if(results.temp[3,2] >= t*w) 'NWHI' else 'Ambiguous'


true.enc = data.frame(rbind(results.pmtemp[1,1], results.pmtemp[2,2]))
...
sink("C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018\\ConfMatrixPM_means_20181211.txt", append=T)
...
write.table(output_CorrectClass.pm, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018/20181209_PM_100x/PcResults_ConfusionMatrix_PM_20181209.csv", append = T, row.names = T, col.names=T, sep = ",")

write.table(output_Results.pm, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018/20181209_PM_100x/PcResults_TotalResults_PM_20181209.csv", append = T, row.names = T, col.names=T, sep = ",")

write.table(output_WhistleClass.pm, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018/20181209_PM_100x/PcResults_TotalWhistleClass_PM_20181209.csv", append = T, row.names = F, col.names=T, sep = ",")

write.table(output_TrainSetAll.pm, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018/20181209_PM_100x/PcResults_TrainSets_PM_20181209.csv", append = T, col.names=T, sep = ",")

write.table(output_TestSetAll.pm, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018/20181209_PM_100x/PcResults_TestResults_PM_20181209.csv", append = T, col.names=T, sep = ",")

write.table(output_varIMPtotal.pm, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018/20181209_PM_100x/PcResults_ImportantVars_PM_20181209.csv", append = T, col.names=T, sep = ",")

write.table(tunedAll.pm, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018/20181209_PM_100x/PcResults_TunedParameters_PM_20181209.csv", append = T, col.names=T, sep = ",")

write.table(output_ModelFit.pm, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018/20181209_PM_100x/PcResults_TotalModels_PM_20181209.csv", append = T, col.names=F, sep = ",")
...
my_data <- read.csv('data/results/PcResults_TotalResults_PM_20181209.csv')

...
#6.
  # Important Variables
  varIMPtemp.pm <- as.data.frame(fit.pm$importance)
  varIMP.pm <- varIMPtemp.pm[order(varIMPtemp.pm$MeanDecreaseGini), , drop =F]
  output_varIMPtotal.pm <- cbind(rep, rbind(output_varIMPtotal.pm, varIMP.pm))
...
write.table(output_CorrectClass.pm, "data\\results/PcResults_PM_ConfusionMatrix_20190325.csv", append = T, row.names = T, col.names=T, sep = ",")

write.table(output_results_pm, "data\\results\\PcResults_PM_TotalResults_20190325.csv", append = T, row.names = T, col.names=T, sep = ",")
...
write.table(output_TrainSetAll.pm, "data\\results\\PcResults_PM_TrainSets_20190325.csv", append = T, col.names=T, sep = ",")

write.table(output_TestSetAll.pm, "data\\results\\PcResults_PM_TestResults_20190325.csv", append = T, col.names=T, sep = ",")

write.table(output_varIMPtotal.pm, "data\\results\\PcResults_PM_ImportantVars_20190325.csv", append = T, col.names=T, sep = ",")

write.table(tunedAll.pm, "data\\results\\PcResults_PM_TunedParameters_20190325.csv", append = T, col.names=T, sep = ",")

write.table(output_ModelFit.pm, "data\\results\\PcResults_PM_TotalModels_20190325.csv", append = T, col.names=F, sep = ",")


write.table(pc_classPM, "data/results/PcResults_PM_EncounterClass_20190325.csv", append = F, col.names=T, row.names = F, sep = ",")

...
n_samps = 20         #number of times you want to resample from your dataset
...
correctP <- results.pm[1,1]/(results.pm[1,1]+results.pm[1,2])*100
correctM <- results.pm[2,2]/(results.pm[2,1]+results.pm[2,2])*100

output_CorrectClass <- rbind(results.pm,cbind(correctP, correctM))
...
write.table(output_CorrectClass, "C:\\Users\\yvers\\OneDrive\\PHD\\CHP1-FKW\\data\\results\\2018/PcResults_ConfusionMatrix_PM_20180822.csv", append = T, row.names = T, col.names=T, sep = ",")

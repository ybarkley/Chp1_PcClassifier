...
pcdata.pm <- read.csv('C:\\Users\\Yvonne\\Documents\\PHD\\CHP1-FKW\\data/results/20180717/pcdata.pm_uncorrelated_20180717.csv')
...
#test.pm <- subset(pcdata.pm, pcdata.pm$group == 8)
...
formPc <- as.formula(paste("population ~ ", paste(names(pcdata.pm)[7:32],collapse="+")))
...
fit_error_rate = c(fit_error_rate, fit.pm$err.rate)
...
#g.pm2=as.data.frame(cbind(prediction.vote$aggregate, prediction.vote$individual))
...
```{r}
write.table(output_EncounterClass.pm, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180720//Top5ImpVar_PcResults_TotalEncounterClass_newPvM_NoPel8.csv", append = T, row.names = T, col.names=T, sep = ",")

write.table(output_WhistleClass.pm, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180720//Top5ImpVar_PcResults_TotalWhistleClass_newPvM_NoPel8.csv", append = T, row.names = F, col.names=T, sep = ",")

# write.table(output_ConfMat.pm, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180717//PcResults_TotalConfMatrix_newPvM_NoPel8.csv", append = T, col.names=F, sep = ",")

write.table(output_TrainSet.pmAll, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180720//Top5ImpVar_PcResults_TrainSets_newPvM_NoPel8.csv", append = T, col.names=T, sep = ",")

write.table(output_TestSet.pmAll, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180720//Top5ImpVar_PcResults_TestResults_newPvM_NoPel8.csv", append = T, col.names=T, sep = ",")

write.table(output_varIMPtotal.pm, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180720//Top5ImpVar_PcResults_ImportantVars_newPvM_NoPel8.csv", append = T, col.names=T, sep = ",")

write.table(tuned.pmAll, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180720//Top5ImpVar_PcResults_TunedParameters_newPvM_NoPel8.csv", append = T, col.names=T, sep = ",")

```
```{r}
rndF1 <- randomForest(train.X, train.Y, test.X, test.Y)
plot(rndF1)
rndF1.legend <- if (is.null(fit.pm$test$err.rate)) {colnames(fit.pm$err.rate)}
                else {colnames(fit.pm$test$err.rate)}

legend("top", cex =0.5, legend=fit.pm, lty=c(1,2,3), col=c(1,2,3), horiz=T)

...
n_samps = 20        #Zack: number of times you want to resample from your dataset
...
write.table(results, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180818//PcResults_ConfusionMatrix_20180818.csv", append = T, row.names = T, col.names=T, sep = ",")

write.table(output_Results, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180818//PcResults_TotalResults_20180818.csv", append = T, row.names = T, col.names=T, sep = ",")

write.table(output_WhistleClass, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180818//PcResults_TotalWhistleClass_20180818.csv", append = T, row.names = F, col.names=T, sep = ",")

write.table(output_ModelFit, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//20180818//PcResults_TotalModels_20180818.csv", append = T, col.names=F, sep = ",")

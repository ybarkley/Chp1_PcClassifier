...
#6/28/2018
#8/9/2018
ROCCAdata<-read.csv('C:\\Users\\Yvonne\\Documents\\PHD\\CHP1-FKW\\data\\2017- 100 New Whistles/ROCCA Towed Data//BigRoccaFile_PMN_TowedAll_RAW_20180809.csv')
...
#save file
write.csv(pcdata, 'C:\\Users\\Yvonne\\Documents\\PHD\\CHP1-FKW\\data\\2017- 100 New Whistles/ROCCA Towed Data/BigRoccaFile_PMN_TowedAll_EDIT_20180809.csv', row.names=F)
```
...
#Start with all variables and eliminate correlated variables for individual random foreste
pcdata <- read.csv('C:\\Users\\Yvonne\\Documents\\PHD\\CHP1-FKW\\data\\2017- 100 New Whistles/ROCCA Towed Data/BigRoccaFile_PMN_TowedAll_EDIT_20180809.csv')
...
w = 100             # Number of whistles randomly pulled from each group 
...
#Could add in Correlation step right here
pcsub<-all[,7:53]
#corrplot.mixed(cor(pcsub, method= "pearson"), upper="number", lower="circle")
tmp <- cor(pcsub)
tmp[upper.tri(tmp)] <- 0
...
mtry_vals = 5:6
ntree_vals = seq(100,501,100) #from, to, by
...
formPc <- as.formula(paste("population ~ ", paste(names(all)[7:31],collapse="+")))
...
e=cbind(e, true.enc)
colnames(e) = c("EncounterClass", "Pct Correct") #, "EncounterID")
...
#Save each RF confusion matrix and OOB error
...
output_WhistleClass <- smartbind(output_WhistleClass, g, fill = NA, sep=':')

#output_EncounterClass <- rbind(output_EncounterClass, e) ## This is redundant with output_TestSetAll ##
output_Results<-rbind(output_Results, rep, results.temp, accuracy=signif(accuracy, digits = 3)) #rough table keeping track of confusion matrices for all iterations
...
```{r}
write.table(output_EncounterClass, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//PcResults_TotalEncounterClass_20180409.csv", append = T, row.names = T, col.names=T, sep = ",")

write.table(output_WhistleClass, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//PcResults_TotalWhistleClass_20180409.csv", append = T, row.names = F, col.names=T, sep = ",")

write.table(output_ConfMat, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//PcResults_TotalConfMatrix_20180409.csv", append = T, col.names=F, sep = ",")

write.table(output_TrainSetAll, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//PcResults_TrainSets_20180409.csv", append = T, col.names=F, sep = ",")
write.table(output_TestSetAll, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//PcResults_TestSets_20180409.csv", append = T, col.names=F, sep = ",")

write.table(varIMPtotal, "C://Users//Yvonne//Documents//PHD//CHP1-FKW//data//results//PcResults_TotalImportantVars_20180409.csv", append = T, col.names=T, sep = ",")
```

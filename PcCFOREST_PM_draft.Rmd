...
pcdata.pm <- droplevels(filter(pcdata, population != "nwhi"))
...
cformPc <- as.formula(paste("population ~ ", paste(names(pcdata.pm)[7:54],collapse="+"))) #Use variables to classify to population
# 
# 
# 
